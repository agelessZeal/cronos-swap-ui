  ...
  return (
    <Flex flexDirection="column" maxWidth="736px">
      ...
      <HowToCard number={2} title={t('Battle Time')}>
        <Text fontSize="14px" color="textSubtle">
          {t(
            'Trade SANTOS/CRO, PORTO/CRO, LAZIO/CRO, SANTOS/BUSD, PORTO/BUSD, LAZIO/BUSD, CCS/CRO and CCS/BUSD during the battle period to raise both your and your team’s score. See the Rules section below for more.',
          )}
        </Text>
      </HowToCard>
