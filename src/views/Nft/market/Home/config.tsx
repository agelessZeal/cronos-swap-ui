  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WCRO for CRO with no trading fees on CroCoinSwap.'),
      ],
    },
    {
      ...
      description: [
        t(
          'Soon! The current NFT Market is a basic version (phase 1), with early access to trading CroCoinSwap NFTs only.',
        ),
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by CroCoinSwap from sales are used to buy back and BURN CCS tokens in our weekly CCS burns.',
        ),
        t(
