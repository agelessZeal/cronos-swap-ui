...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        CCS up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active CroCoinSwap profile can commit. However the maximum amount of CCS
        user can commit, is equal to the average CCS balance in the IFO CCS pool prior to the IFO. And there’s a fee
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active CroCoinSwap Profile in order to participate.</Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The CCS from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of CCS to either sale.</Trans>,
      <Trans>
