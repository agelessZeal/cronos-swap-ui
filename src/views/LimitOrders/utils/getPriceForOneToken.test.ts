...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [new TokenAmount(CCS, ONE), new TokenAmount(BUSD, ONE), '1'],
    [new TokenAmount(CCS, FIVE), new TokenAmount(BUSD, FIVE), '1'],
    [new TokenAmount(CCS, ONE), new TokenAmount(BUSD, FIVE), '5'],
    [new TokenAmount(CCS, FIVE), new TokenAmount(BUSD, ONE), '0.2'],
    ...
    [new TokenAmount(CCS, ZERO), new TokenAmount(BUSD, ONE), undefined],
    [new TokenAmount(CCS, ONE), new TokenAmount(BUSD, ZERO), undefined],
