...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and CCS pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and CCS pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from CCS pool', data)
  }
