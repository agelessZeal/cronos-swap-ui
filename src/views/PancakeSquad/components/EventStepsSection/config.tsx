  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active CroCoinSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold CCS'),
      bodyText: [t('Each NFT costs CCS to mint. Remember you also need CRO to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
